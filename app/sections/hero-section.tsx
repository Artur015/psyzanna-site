    ...
    <section className="grid gap-6 lg:grid-cols-[1.08fr_0.92fr]">
      <div className="rounded-[2rem] border border-white/65 bg-white/80 p-5 shadow-[0_32px_90px_rgba(50,23,88,0.13)] backdrop-blur sm:p-10">
        ...
        <h1 className="font-display mt-6 max-w-3xl text-3xl leading-[0.94] text-[var(--foreground)] sm:text-3xl sm:leading-none lg:text-3xl">
          Вы можете продолжать жить как сейчас. Или наконец разобраться, что не так, и начать это менять.
        </h1>
        <p className="mt-6 max-w-2xl text-base leading-8 text-[var(--muted-foreground)] sm:text-lg">
          Я работаю не ради разговоров. Я работаю на результат: ясность, решения и реальные изменения в отношениях и
          жизни.
        </p>
        <p className="mt-4 max-w-2xl text-base leading-8 text-[var(--muted-foreground)] sm:text-lg">
          Я работаю онлайн с русскоязычными клиентами в Европе и других странах: индивидуально, с парами и по
          вопросам близости. Для записи на приём достаточно заполнить анкету ниже.
        </p>
        ...
        <div className="mt-10 grid gap-4">
          <article className="rounded-[1.6rem] border border-[var(--border)] bg-[var(--surface-soft)] p-4 sm:p-5">
            ...
            <p className="mt-3 text-base leading-7 text-[var(--foreground)]">
              Структурированная работа, а не хаотичный разговор. Вы уходите не просто с мыслями, а с конкретными
              инсайтами и шагами.
            </p>
          </article>
          <article className="rounded-[1.6rem] border border-[var(--border)] bg-[var(--surface-soft)] p-4 sm:p-5">
            ...
            <p className="mt-3 text-base leading-7 text-[var(--foreground)]">
              Я не даю универсальных советов. Но я помогаю увидеть то, что вы сами не замечаете, и изменить это.
              Иногда это быстро. Иногда непросто. Но всегда про результат.
            </p>
          </article>
          <article className="rounded-[1.6rem] border border-[var(--border)] bg-[var(--surface-soft)] p-4 sm:p-5">
            <p className="text-xs font-semibold uppercase tracking-[0.14em] text-[var(--accent)] sm:text-sm sm:tracking-[0.2em]">
            ...
            <p className="mt-3 text-base leading-7 text-[var(--foreground)]">
              Если вы готовы что-то менять, начнём. Если нет, возможно, сейчас не ваш момент. Но когда будет, я здесь.
              Заполните анкету, и я предложу формат работы, подходящий именно вам.
            </p>
          </article>
        </div>
      </div>
        ...
        <article className="overflow-hidden rounded-[2rem] border border-white/65 bg-[linear-gradient(160deg,var(--accent-deep)_0%,var(--accent)_100%)] p-3 sm:p-4 shadow-[0_28px_80px_rgba(44,19,82,0.18)]">
          ...
          <div className="px-2 pb-2 pt-5">
            ...
            <p className="mt-3 max-w-xl text-base leading-7 text-white/92">
              Я — дипломированный психолог-консультант и сексолог с системным мышлением и опытом за пределами
              классической психологии.
            </p>
            <p className="mt-3 max-w-xl text-base leading-7 text-white/92">
              Моё образование включает MBA в области психологии, профессиональную переподготовку в семейной психологии
              и сексологии, а также финансовое управление.
            </p>
            <p className="mt-3 max-w-xl text-base leading-7 text-white/92">
              10 лет я работала финансовым директором и принимала решения, от которых зависели деньги, люди и
              результат. Позже я создала и управляла собственной компанией.
            </p>
            <p className="mt-3 max-w-xl text-base leading-7 text-white/92">
              Этот опыт формирует мой подход: я не теряюсь в эмоциях и не работаю на уровне «поговорить». Я вижу
              структуры, причины и последствия и работаю там, где действительно происходят изменения.
            </p>
            <p className="mt-3 max-w-xl text-base leading-7 text-white/92">
              В моей практике — регулярная работа с клиентами и личная терапия. Я не новичок и не работаю по шаблону.
            </p>
            <p className="mt-3 max-w-xl text-base leading-7 text-white/92">
              Ко мне приходят, когда важно не просто разобраться в себе, а выйти на уровень, где меняются решения,
          ...
          <div className="grid gap-4 md:grid-cols-[0.9fr_1.1fr] md:items-center">
            ...
            <div className="p-2">
              ...
              <p className="mt-3 text-lg leading-8 text-[var(--foreground)]">
                Комфорт не значит избегание. Здесь безопасно, но честно. Я не буду вас оценивать, но и не буду
                поддерживать иллюзии, которые мешают вам жить лучше.
              </p>
            </div>
          </div>
        </article>
