    ...
    >
      <div>
        ...
        <p className="mt-6 max-w-2xl text-lg leading-8 text-[var(--muted-foreground)] sm:text-lg">
          Ко мне приходят не просто поговорить. Приходят, когда повторяются одни и те же сценарии, когда в отношениях
          нет ясности и когда становится понятно: дальше так не работает. Мы не уходим в общие рассуждения. Мы
          находим, что именно не так, и что с этим делать в реальной жизни.
        </p>
        <p className="mt-4 max-w-2xl text-lg leading-8 text-[var(--muted-foreground)] sm:text-lg">
          Если вам нужен русскоязычный психолог онлайн, с которым можно говорить прямо, глубоко и по делу, моя работа
          строится именно на этом: не только понять происходящее, но и прийти к изменениям в решениях, поведении и
          отношениях.
        </p>
      </div>
